            ...
            <aside className="hidden xl:block" aria-labelledby="sidebar-label">
                <div className="xl:w-[336px] sticky top-24">
                    ...
                    <div className="p-4 mb-6 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="mb-6">
                            <h5 className="mb-2 text-lg font-bold leading-tight text-gray-900 dark:text-white">Конкурентная борьба</h5>
                        ...
                        <div className="mb-6">
                            <h5 className="mb-2 text-lg font-bold leading-tight text-gray-900 dark:text-white">Скидка как аргумент продажи</h5>
                            <p className="mb-2 font-light text-gray-500 dark:text-gray-400">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
                            <a href="#" className="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 dark:text-primary-500 hover:no-underline">
                                Подробнее
                            </a>
                        ...
                        <div className="mb-6">
                            <h5 className="mb-2 text-lg font-bold leading-tight text-gray-900 dark:text-white">Лучший дизайнер года</h5>
                            <p className="mb-2 font-light text-gray-500 dark:text-gray-400">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
                            <a href="#" className="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 dark:text-primary-500 hover:no-underline">
                                Подробнее
                            </a>
                ...
                <form action="#">
                    <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        <div className="relative w-full">
                            ...
                            <input className="block p-3 pl-10 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Введите вашу почту" type="email" id="email" required=""/>
                        </div>
                        <div>
                            <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-primary-700 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Подписаться</button>
                        </div> 
                    </div>
                    <div className="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300">Мы заботимся о защите ваших данных. <a href="#" className="font-medium text-primary-600 dark:text-primary-500 hover:underline">Политика безопасности</a>.</div>
                </form>
            </div>
        </div>
        </section>
