  ...
  return (
    <section className="bg-white dark:bg-gray-900">
        <div className="pt-8 mx-auto max-w-full px-8 sm:px-16 lg:px-24 sm:text-center lg:pt-32 text-center">
            <h2 className="font-[lato] mb-4 text-3xl md:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Разнообразие <br className="md:hidden" /> цветов и оттенков</h2>
