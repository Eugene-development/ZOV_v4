    ...
    <>
      <div className="bg-gray-50">
        ...
        <div className=" mb-8 lg:mb-16 text-center">
            <h2 className="font-[lato] mb-4 text-3xl md:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Мебель <br className="md:hidden" /> для дома и офиса</h2>
